...
public class MaterialDialogUtil {
    ...
    public static MaterialDialog.Builder applyOptions(
    ...
    public static MaterialDialog buildDialog(Activity mActivity,
                                             ReadableMap options, final Callback callback,
                                             MaterialDialog mDialog) {
        MaterialDialog.Builder mBuilder = new MaterialDialog.Builder(mActivity);
        try {
            MaterialDialogUtil.applyOptions(mBuilder, options);
        } catch (Exception e) {
